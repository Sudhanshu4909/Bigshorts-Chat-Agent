    ...
    def process_query(self, user_input: str) -> Union[str, dict]:
        ...
        if user_input.startswith("FAQ:"):
            ...
            try:
                ...
                # Special handling for bigcoins reward system
                if selected_content_type == "bigcoins_reward":
                    bigcoins_info = {
                        ...
                        "content": {
                            ...
                            "rewards": [
                                ...
                                {"action": "Time Spent (5-9 mins)", "reward": "5 Bigcoins", "description": "Spend 5–9 minutes daily"},
